...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <nav className={`nav-bar ${isNavOpen ? "open" : ""}`} id="nav-bar">
        <NavLink className="logo" to={'/'} onClick={closeNav}>
          <img src='images/mainlogo.png' alt="logo" />
        </NavLink>
        <p>Web Developer</p>
        <ul>
          <NavLink style={navLinkStyles} to='/' onClick={closeNav} exact>Home</NavLink>
          <NavLink style={navLinkStyles} to='/About' onClick={closeNav}>About</NavLink>
          <NavLink style={navLinkStyles} to='/Skills' onClick={closeNav}>Skills</NavLink>
          <NavLink style={navLinkStyles} to='/Work' onClick={closeNav}>Work</NavLink>
          <NavLink style={navLinkStyles} to='/Contact' onClick={closeNav}>Contact</NavLink>
        </ul>
        <div className="logos">
          <a href={githubProfileUrl} target="_blank" rel="noopener noreferrer">
            <FaGithub style={iconStyle} />
